...
- `regeneratable`: data can be rebuilt, re-downloaded, or recreated by developer tools.
...
| --- | --- | --- | --- |
| `xcode-derived-data` | `~/Library/Developer/Xcode/DerivedData` | `regeneratable` | Delete selected directories after explicit category or item selection. |
...
| `xcode-cache` | `~/Library/Caches/com.apple.dt.Xcode` and related Xcode caches | `regeneratable` | Delete selected cache directories. |
...
| `coredevice-delta` | `~/Library/Developer/CoreDevice/AppInstallationBinaryDeltas` | `regeneratable` | Delete selected delta cache directories. |
| `developer-artifact` | `.build`, `node_modules`, `.next`, `.turbo`, `Pods`, `dist`, `build` under selected artifact roots | `regeneratable` | Delete selected artifact directories only, never the source root. |
...
| `vscode-cache` | VS Code `Cache`, `CachedData`, `GPUCache`, `logs` | `regeneratable` | Delete selected cache directories. |
| `common-cache` | common developer caches under `~/Library/Caches` | `regeneratable` | Delete selected cache directories. |
...
| `wechat-cache` | WeChat cache folders under container caches | `regeneratable` | Delete selected cache directories. |
