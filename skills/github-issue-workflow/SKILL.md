...
Use GitHub Issues as the source of truth for engineering scope, implementation acceptance criteria, live execution progress, and engineering completion state.
