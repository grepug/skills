...
10. 正文范围、对象、验收路径或核心规则发生变化后，主动检查 issue 标题是否仍准确；如果标题已经变窄、变宽或指向旧范围，应同步更新标题，或在需要负责人判断时提出标题调整建议。
11. 使用 Linear 评论讨论产品合同、请求决策、说明阻塞和总结正文变更。
12. 如果需要产品决策，使用工作区的确认机制标记。
13. 决策后，把 issue 正文和最新已接受合同对齐，让正文直接呈现最终版本，并把历史上下文保留在评论中。
14. 如果决策影响长期产品文档，编辑文档前先询问是否同步。
15. 如果开发执行需要 GitHub issue 或 PR 链接，创建或更新对应 artifact，并反向链接到 Linear。
