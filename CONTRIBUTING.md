...
- Keep issue, canonical-plan, and execution-status comment examples deterministic; do not introduce sections such as `Options considered`, alternatives, pros / cons, recommendation blocks, or chat-style option menus
